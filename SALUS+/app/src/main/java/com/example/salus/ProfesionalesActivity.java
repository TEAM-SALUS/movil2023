...
public class ProfesionalesActivity extends AppCompatActivity {
    ...
    public void listarUsuario() {
        ...
        if(lista.size() == 0) {
            usuNI.insertar(new Usuario(11111111, "Nombre Uno", "Apellido Uno", "Direccion 1", "Ciudad 1", "Telefono 1", true,conNI.listarUno(1, context)), context);
            usuNI.insertar(new Usuario(22222222, "Nombre Dos", "Apellido Dos", "Direccion 2", "Ciudad 2", "Telefono 2", true,conNI.listarUno(2, context)), context);
            usuNI.insertar(new Usuario(0, "Nombre Admin", "Apellido Admin", "Direccion Admin", "Ciudad Admin", "Telefono Admin", true,conNI.listarUno(3, context)), context);
        }
        String listaTxt = "";
        for (Usuario u : lista) {
            listaTxt += u.toString() + "\n";
    ...
    public void actualizarUsuario(){
        Usuario u = new Usuario(11111111, "Nombre Nuevo", "Apellido Nuevo", "Direccion Nuevo", "Ciudad Nuevo", "Telefono Nuevo", true,conNI.listarUno(1, context));
        ...
        Log.d("Usuario id 11111111 - descrpcion nueva", usuNI.listarUno(11111111, context).toString());
        u = new Usuario(11111111, "Nombre Uno", "Apellido Uno", "Direccion 1", "Ciudad 1", "Telefono 1", true,conNI.listarUno(1, context));
        usuNI.editar(u, context);
        Log.d("Usuario id 11111111 - descrpcion final", usuNI.listarUno(11111111, context).toString());
    }
    public void eliminarUsuario() {
        usuNI.insertar( new Usuario(444444444, "Nombre Cuatro", "Apellido Cuatro", "Direccion 4", "Ciudad 4", "Telefono 4", true,conNI.listarUno(1, context)), context);
